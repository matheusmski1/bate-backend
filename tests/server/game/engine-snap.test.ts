...
function baseState(): GameState {
  const p1: Player = { id: 'p1', socketId: null, name: 'A', hand: [card('7', 'clubs'), card('K')], score: 0, connected: true, disconnectedAt: null, revealedToSelf: [], skin: 'default', deck: 'default' }
  const p2: Player = { id: 'p2', socketId: null, name: 'B', hand: [card('7', 'diamonds'), card('3')], score: 0, connected: true, disconnectedAt: null, revealedToSelf: [], skin: 'default', deck: 'default' }
  return {
